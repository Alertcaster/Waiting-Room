...
Copy and paste this code to your web server and you'll have your own Waiting Room service.
...
NOTE: To activate this API, you'll need to sign-up for an Alertcaster account at developer.alertcaster.com.  Once signed up, go to the 
